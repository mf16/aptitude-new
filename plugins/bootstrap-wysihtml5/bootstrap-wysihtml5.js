        ...
        "font-styles": function(locale, options) {
            ...
            return "<li class='dropdown'>" +
              ...
              "<ul class='dropdown-menu'>" +
                ...
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h1' tabindex='-1'><h1 class='no-mg'>" + locale.font_styles.h1 + "</h1></a></li>" +
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h2' tabindex='-1'><h2 class='no-mg'>" + locale.font_styles.h2 + "</h2></a></li>" +
                "<li><a data-wysihtml5-command='formatBlock' data-wysihtml5-command-value='h3' tabindex='-1'><h3 class='no-mg'>" + locale.font_styles.h3 + "</h3></a></li>" +
              "</ul>" +
            "</li>";
        },
